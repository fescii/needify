...
export default class AppLogon extends HTMLElement {
  ...
  setTitle = () => {
    document.title = 'Needify - Join, Login, and Explore';
  }
  ...
  getHeader() {
    return `
      <div class="head">
				<div class="logo">
					<h2 class="main">
						<span class="action">Join</span> - Needify</h2>
					<span class="slogan">Bid for services you need or products you want</span>
				</div>
			</div>
    `
  }
    ...
    return /*html*/`
      <div class="welcome">
				...
				<div class="info">
					...
					By continuing you indicate that you agree to <a href="" class="aduki">needify's</a> <a href="">Terms of Service</a> and <a href="">Privacy
						Policy</a>.
				</div>
			</div>
    `
    ...
    return /*html*/`
      <div class="finish">
        <h2 class="title">Welcome!</h2>
				<p>
					Dear ${data.name} your account has been created successfully. Please log in into your account.
				</p>
